...
const SLIDES = [
  {
    id: 1,
    title: "AUTUMN / WINTER 2026 RUNWAY",
    subtitle: "THE RAW SILK & VELVET ATELIER COLLECTION",
    ctaText: "EXPLORE THE RUNWAY",
    ctaLink: "/catalog?category=outerwear",
    image: "https://images.unsplash.com/photo-1544441893-675973e31985?q=80&w=1800",
  },
  {
    id: 2,
    title: "BESPOKE DOUBLE-BREASTED TAILORING",
    subtitle: "ENGLISH RAW WOOL & HAND-STITCHED LAPELS",
    ctaText: "DISCOVER TAILORED SUITS",
    ctaLink: "/catalog?category=tailored-suits",
    image: "https://images.unsplash.com/photo-1594938298603-c8148c4dae35?q=80&w=1800",
  },
  {
    id: 3,
    title: "MONOGRAM LEATHER HOLDALLS",
    subtitle: "HAND-BURNISHED COGNAC & BRONZE HARDWARE",
    ctaText: "SHOP LEATHER GOODS",
    ctaLink: "/catalog?category=leather-goods",
